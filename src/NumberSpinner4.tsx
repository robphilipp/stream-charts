...
function NumberSpinner4(props: Props): JSX.Element {
    ...
    useEffect(
        () => {
            if (d3ContainerRef.current) {
                ...
                const maxTime = calcMaxTime(liveData);
        ...
        [liveData, timeWindow, seriesHeight, plotWidth, spikesMargin]
    );
